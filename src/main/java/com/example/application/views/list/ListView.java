...
import com.example.application.data.service.AuctionService;
...
public class ListView extends VerticalLayout {
    ...
    Grid<Auction> grid = new Grid<>(Auction.class);
...
//                .set("max-width", "100%");
    ...
    private void configureGrid() {
        ...
        grid.setColumns("startingPrice", "currentBid");
        grid.addColumn(auction -> auction.getSeller().getFirstName()).setHeader("Seller name");
//        grid.addColumn(Auction::getCurrentBid).setHeader("Current Bid");
